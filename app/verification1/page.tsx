  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-white">
      ...
      <div className="flex flex-1 items-center justify-center px-4">
        <div className="w-[960px] max-w-full h-[640px] max-h-[calc(100%-4rem)] bg-white rounded-md shadow-xl flex flex-col justify-center items-center p-6 sm:p-8">
            ...
            {Array.from({ length: 6 }).map((_, index) => (
              ...
              >
                <input
                  type="text"
                  maxLength={1}
                  className="w-full h-full bg-transparent border-none text-center text-black font-semibold"
                  placeholder="-"
                />
              </div>
            ))}
